        ...
        services
            ...
            .AddJwtBearer(options =>
            {
                ...
                options.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    // In Docker, tokens are obtained via localhost:8080 (iss: http://localhost:8080/realms/jobflow)
                    // but the API reaches Keycloak internally via keycloak:8080 for JWKS discovery.
                    // Accept both issuers to handle this mismatch.
                    ValidIssuers = [authority, "http://localhost:8080/realms/jobflow"]
                };
            });
